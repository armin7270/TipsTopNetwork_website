...
> 🚚 **اتمام تریال Railway؟ انتقال به اکانت جدید بدون از دست رفتن داده:** راهنمای کامل مهاجرت خودکار (state sync از طریق گیت‌هاب) در [`RAILWAY-MIGRATION.md`](RAILWAY-MIGRATION.md).
